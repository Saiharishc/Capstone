...
library(lubridate)
getwd()
setwd("C:\\Users\\Sai\\Downloads\\Hackathon_linear")

data1 <- read.csv("C:\\Users\\Sai\\Downloads\\Hackathon_linear\\DSA_Hackathon_Dataset.csv")
summary(data1)
str(data1)
...
#validation
valData <- read.csv("C:\\Users\\Sai\\Downloads\\Hackathon_linear\\DSA_Hackathon_Validation_Dataset.csv")
